    ...
    return (
        <div className="App">
            ...
            <div className="navigation-buttons">
                ...
                <RxSlash className="navigation-buttons-slash-icon"/>
                <Link to="/products?search=audio" onClick={() => {
                    window.scroll(0, 0);
                }}>
                    <button className="navigation-buttons-button">Audio</button>
                </Link>
            </div>
            <div className="product-main-page-content">
                <div className="product-main-page-content-left">
                    <div className="searched-item-name-container">
                        <p className="searched-item-name-text">QFX RETRO-39 Casette Player</p>
                    </div>
                    <div className="product-main-page-content-left-image-box">
                        <img className="product-main-page-content-left-image" src={retrocassete} alt={retrocassete}></img>
                    </div>
